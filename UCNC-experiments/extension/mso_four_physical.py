...
MSO_eight = mso.generate_MSO(resolution_4, [mso.MSO.one.value, mso.MSO.two.value, mso.MSO.three.value, mso.MSO.four.value])
MSO_eight = MSO_eight/8 # scale the input to be between [-0.5, 0.5]
...
def compare_distributions(N, n_subgroups):
    ...
    # save nrmses
    buf_nrmse = f"/home/cw1647/phd/UCNC-experiments/extension/mso_four_patch/size{N}-subgroups{n_subgroups}-subgroups-{n_subgroups}-dw-{DW}-do{DB}.csv"
