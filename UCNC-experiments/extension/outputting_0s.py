...
MSO8_array = MSO_eight[TWashout+TTrain:TWashout+TTrain+TTest]
MSO4_array = MSO_four[TWashout+TTrain:TWashout+TTrain+TTest]
MSO2_array = MSO_two[TWashout+TTrain:TWashout+TTrain+TTest]

zeros = np.zeros((TTest))

print(f"MSO8: {NymphESN.errorfuncs.ErrorFuncs.nrmse(zeros, MSO8_array)}")
print(f"MSO4: {NymphESN.errorfuncs.ErrorFuncs.nrmse(zeros, MSO4_array)}")
print(f"MSO2: {NymphESN.errorfuncs.ErrorFuncs.nrmse(zeros, MSO2_array)}")
...
#     fig, ax = plt.subplots()
#     ax.plot(resolution_4[:700], MSO_eight[:700], label="intended data")
#     ax.plot(resolution_4[:700], restricted.vall.flatten(), label="restricted_output")
#     ax.plot(resolution_4[:700], standard.vall.flatten(), label="standard_output")
#     ax.legend()
#     fig.savefig("/home/cw1647/phd/UCNC-experiments/sanity/outputting_0s.png")
#         #nrmse test error
