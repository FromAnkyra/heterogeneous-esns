...
def experiment_single_timescale(name="NARMA"):
    ...
    buf_nrmse = f"/home/cw1647/phd/fakemat_experiments/results/normalised_total_svd/single_timescale/{name}.csv"    # bufvis = f"/home/cw1647/phd/UCNC-experiments/results/narma-physical-again/size-{N}-subgroups-{n_subgroups}-sw-{density}-so-{so}.svg"
...
def experiment_multi_timescale(name="NARMA"):
    ...
    buf_nrmse = f"/home/cw1647/phd/fakemat_experiments/results/normalised_total_svd/multi_timescale/{name}.csv"    # bufvis = f"/home/cw1647/phd/UCNC-experiments/results/narma-physical-again/size-{N}-subgroups-{n_subgroups}-sw-{density}-so-{so}.svg"
    nrmsedf.to_csv(buf_nrmse)
    print("done!")
