...
def compare_distributions(N, n_subgroups):
    ...
    # save nrmses
    buf_nrmse = f"/home/cw1647/phd/tempESN-experiments/ridge_regression/results/nrmses/mso_four.csv"
    nrmsedf.to_csv(buf_nrmse)

    # save mses 
    buf_mse = f"/home/cw1647/phd/tempESN-experiments/ridge_regression/results/mses/mso_four.csv"
