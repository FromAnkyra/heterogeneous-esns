...
MSO_two = mso.generate_MSO(resolution_4, [mso.MSO.eight.value, mso.MSO.seven.value])
...
def compare_distributions(N, n_subgroups):
    ...
    for i in range(TRuns):
        ...
        standard = nymph.NymphESN(1, subreservoir_N*2, 1, density=DW, seed=i, svd_dv=0.1)
        restricted = nymph.NymphESN(1, subreservoir_N*2, 1, density=DW, seed=i, svd_dv=0.1)
        ...
        gondor = temp.Temporal_ESN(1, subreservoir_N*2, 1, NR, gondor_encodings, seed=i, svd_dv=0.1)
        gondor.set_rhythms(rhythm_two)
        gondor.set_weights(W)
        circuit = temp.Temporal_ESN(1, subreservoir_N*2, 1, NR, circuit_encodings, seed=i, svd_dv=0.1)
    ...
    # save nrmses
    buf_nrmse = f"/home/cw1647/phd/tempESN-experiments/mso_reverse/results/nrmses/mso_two.csv"
    nrmsedf.to_csv(buf_nrmse)

    # save mses 
    buf_mse = f"/home/cw1647/phd/tempESN-experiments/mso_reverse/results/mses/mso_two.csv"
